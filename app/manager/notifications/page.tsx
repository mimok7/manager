            ...
            <div className="flex flex-wrap items-center gap-2">
              {[
                ...
                <button
                  ...
                  className={`px-3 py-1.5 text-sm rounded-md border transition-colors ${categoryFilter === c.key
